...
@:pythonImport("spacy.lang.uk.lemmatizer", "UkrainianLemmatizer") extern class UkrainianLemmatizer {
	...
	**/
	...
	public function _pymorphy_lemmatize(token:Dynamic):Dynamic;
	public function _pymorphy_lookup_lemmatize(token:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function pymorphy3_lemmatize(token:Dynamic):Dynamic;
	public function pymorphy3_lookup_lemmatize(token:Dynamic):Dynamic;
	/**
