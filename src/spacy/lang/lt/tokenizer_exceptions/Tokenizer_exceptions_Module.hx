...
package spacy.lang.lt.tokenizer_exceptions;
@:pythonImport("spacy.lang.lt.tokenizer_exceptions") extern class Tokenizer_exceptions_Module {
	...
	static public var mod_base_exceptions : Dynamic;
	static public var orth : Dynamic;
	/**
