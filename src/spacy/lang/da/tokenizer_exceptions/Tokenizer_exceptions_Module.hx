...
package spacy.lang.da.tokenizer_exceptions;
@:pythonImport("spacy.lang.da.tokenizer_exceptions") extern class Tokenizer_exceptions_Module {
	...
	static public var _custom_base_exc : Dynamic;
	static public var _exc : Dynamic;
	static public var capitalized : Dynamic;
