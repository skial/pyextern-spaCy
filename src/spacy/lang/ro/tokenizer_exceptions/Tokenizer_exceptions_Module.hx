...
package spacy.lang.ro.tokenizer_exceptions;
@:pythonImport("spacy.lang.ro.tokenizer_exceptions") extern class Tokenizer_exceptions_Module {
	...
	static public function _make_ro_variants(tokens:Dynamic):Dynamic;
	static public var orth : Dynamic;
	/**
