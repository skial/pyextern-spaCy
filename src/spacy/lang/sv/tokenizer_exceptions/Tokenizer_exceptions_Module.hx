...
package spacy.lang.sv.tokenizer_exceptions;
@:pythonImport("spacy.lang.sv.tokenizer_exceptions") extern class Tokenizer_exceptions_Module {
	static public var ABBREVIATIONS : Dynamic;
