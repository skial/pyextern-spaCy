...
@:pythonImport("spacy.schemas", "TokenPatternOperatorSimple") extern class TokenPatternOperatorSimple {
	/**
		Return self+value.
	**/
	...
	**/
	...
	static public var exclamation : Dynamic;
	/**
	...
	**/
	...
	static public var plus : Dynamic;
	...
	**/
	...
	static public var star : Dynamic;
	/**
