...
package spacy.tokens._dict_proxies;
@:pythonImport("spacy.tokens._dict_proxies", "SpanGroups") extern class SpanGroups {
	...
	**/
	@:native("__init__")
	public function ___init__(doc:Dynamic, ?items:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(doc:Dynamic, ?items:Dynamic):Void;
	/**
	...
	**/
	...
	public function _ensure_doc():Dynamic;
	public function _make_span_group(name:Dynamic, spans:Dynamic):Dynamic;
	/**
		D.clear() -> None.  Remove all items from D.
	**/
	public function clear():Dynamic;
	public function copy(?doc:Dynamic):Dynamic;
